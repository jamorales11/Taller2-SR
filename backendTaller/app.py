...
def get_recomendaciones(id):
    ...
    return jsonify(recommendaciones=recommendations.to_json(orient="records"), features= imp_feat.to_json(orient="records"), usuarios = imp_user.to_json(orient="records"))
